 ...
 */
extern DECLSPEC SDL_bool SDLCALL
SDL_EnclosePoints(const SDL_Point* points, int count, const SDL_Rect* clip, SDL_Rect* result);
 ...
 */
SDL_FORCE_INLINE SDL_bool
SDL_FRectEmpty(const SDL_FRect* r)
{
 ...
 */
SDL_FORCE_INLINE SDL_bool
SDL_FRectEqualsEpsilon(const SDL_FRect* a, const SDL_FRect* b, const float epsilon)
{
    return (a && b
            && ((a == b)
                || ((SDL_fabs(a->x - b->x) <= epsilon) && (SDL_fabs(a->y - b->y) <= epsilon)
                    && (SDL_fabs(a->w - b->w) <= epsilon) && (SDL_fabs(a->h - b->h) <= epsilon))))
                   ? SDL_TRUE
                   : SDL_FALSE;
}
 ...
 */
SDL_FORCE_INLINE SDL_bool
SDL_FRectEquals(const SDL_FRect* a, const SDL_FRect* b)
{
