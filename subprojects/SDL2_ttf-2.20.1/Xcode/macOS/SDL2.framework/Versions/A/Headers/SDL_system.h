...
typedef void(SDLCALL* SDL_WindowsMessageHook)(
        void* userdata,
        void* hWnd,
 ...
 */
extern DECLSPEC int SDLCALL
SDL_AndroidShowToast(const char* message, int duration, int gravity, int xoffset, int yoffset);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_AndroidSendMessage(Uint32 command, int param);
 ...
 * \since This function is available since SDL 2.0.8.
 */
extern DECLSPEC SDL_WinRT_DeviceFamily SDLCALL
