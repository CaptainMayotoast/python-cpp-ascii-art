 ...
 * SDL_NumJoysticks(), with the exact joystick behind a device_index changing as joysticks are plugged
 * and unplugged.
 *
 ...
 *
 * The term JoystickGUID is a stable 128-bit identifier for a joystick device that does not change over
 * time, it identifies class of the device (a X360 wired controller for example). This identifier is
 * platform dependent.
 */
