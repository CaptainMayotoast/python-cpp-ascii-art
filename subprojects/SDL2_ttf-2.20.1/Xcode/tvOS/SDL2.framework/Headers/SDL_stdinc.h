...
extern DECLSPEC void* SDLCALL
SDL_calloc(size_t nmemb, size_t size);
extern DECLSPEC void* SDLCALL
SDL_realloc(void* mem, size_t size);
extern DECLSPEC void SDLCALL
SDL_free(void* mem);
...
extern DECLSPEC wchar_t* SDLCALL
...
SDL_strlwr(char* str);
extern DECLSPEC char* SDLCALL
SDL_strchr(const char* str, int c);
extern DECLSPEC char* SDLCALL
SDL_strrchr(const char* str, int c);
extern DECLSPEC char* SDLCALL
...
extern DECLSPEC double SDLCALL
SDL_strtod(const char* str, char** endp);
...
extern DECLSPEC int SDLCALL
SDL_snprintf(
        SDL_OUT_Z_CAP(maxlen) char* text,
        size_t maxlen,
...
extern DECLSPEC int SDLCALL
SDL_asprintf(char** strp, SDL_PRINTF_FORMAT_STRING const char* fmt, ...) SDL_PRINTF_VARARG_FUNC(2);
extern DECLSPEC int SDLCALL
...
extern DECLSPEC size_t SDLCALL
SDL_iconv(SDL_iconv_t cd, const char** inbuf, size_t* inbytesleft, char** outbuf, size_t* outbytesleft);
 ...
 */
extern DECLSPEC char* SDLCALL
SDL_iconv_string(const char* tocode, const char* fromcode, const char* inbuf, size_t inbytesleft);
...
SDL_FORCE_INLINE void*
SDL_memcpy4(
        SDL_OUT_BYTECAP(dwords * 4) void* dst,
