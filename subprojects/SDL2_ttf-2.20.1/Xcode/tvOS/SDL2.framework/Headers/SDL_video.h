...
typedef enum {
    ...
    SDL_WINDOWEVENT_TAKE_FOCUS, /**< Window is being offered a focus (should SetWindowInputFocus() on
...
typedef enum {
    ...
    SDL_ORIENTATION_LANDSCAPE, /**< The display is in landscape mode, with the right side up, relative to
                                  portrait mode */
...
SDL_GetClosestDisplayMode(int displayIndex, const SDL_DisplayMode* mode, SDL_DisplayMode* closest);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_SetWindowGammaRamp(SDL_Window* window, const Uint16* red, const Uint16* green, const Uint16* blue);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_GetWindowGammaRamp(SDL_Window* window, Uint16* red, Uint16* green, Uint16* blue);
 ...
 */
extern DECLSPEC int SDLCALL
SDL_SetWindowHitTest(SDL_Window* window, SDL_HitTest callback, void* callback_data);
 ...
 */
extern DECLSPEC SDL_GLContext SDLCALL
