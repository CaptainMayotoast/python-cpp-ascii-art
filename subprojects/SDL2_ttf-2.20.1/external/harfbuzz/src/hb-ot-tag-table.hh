...
static const LangTag ot_languages[] = {
    ...
    {"aao",
     HB_TAG ('A', 'R', 'A', ' ')}, /* Algerian Saharan Arabic -> Arabic */
    ...
    {"aig", HB_TAG ('C',
		    'P',
		    'P',
		    ' ')}, /* Antigua and Barbuda Creole English -> Creoles */
    {"aii",
    ...
    {"apm",
     HB_TAG (
	 'A', 'T', 'H', ' ')}, /* Mescalero-Chiricahua Apache -> Athapaskan */
    ...
    {"avl",
     HB_TAG (
	 'A', 'R', 'A', ' ')}, /* Eastern Egyptian Bedawi Arabic -> Arabic */
    ...
    {"ayp",
     HB_TAG ('A', 'R', 'A', ' ')}, /* North Mesopotamian Arabic -> Arabic */
    ...
    {"azd",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Eastern Durango Nahuatl -> Nahuatl */
    {"azj", HB_TAG ('A', 'Z', 'E', ' ')}, /* North Azerbaijani -> Azerbaijani */
    {"azn",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Western Durango Nahuatl -> Nahuatl */
    {"azz",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Highland Puebla Nahuatl -> Nahuatl */
    {"ba", HB_TAG ('B', 'S', 'H', ' ')},  /* Bashkir */
    {"bad", HB_TAG ('B', 'A', 'D', '0')}, /* Banda [family] */
    {"bag", HB_TAG_NONE},		  /* Tuki != Baghelkhandi */
    {"bah",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Bahamas Creole English -> Creoles */
    ...
    {"bbz", HB_TAG ('A',
		    'R',
		    'A',
		    ' ')}, /* Babalia Creole Arabic (retired code) -> Arabic */
    ...
    {"bhk",
     HB_TAG ('B', 'I', 'K', ' ')}, /* Albay Bicolano (retired code) -> Bikol */
    ...
    {"bjq", HB_TAG ('M', 'L', 'G', ' ')},   /* Southern Betsimisaraka Malagasy
					       (retired code) -> Malagasy */
    ...
    {"bln",
     HB_TAG ('B', 'I', 'K', ' ')}, /* Southern Catanduanes Bikol -> Bikol */
    ...
    {"bmm",
     HB_TAG (
	 'M', 'L', 'G', ' ')}, /* Northern Betsimisaraka Malagasy -> Malagasy */
    {"bn", HB_TAG ('B', 'E', 'N', ' ')},  /* Bengali */
    {"bo", HB_TAG ('T', 'I', 'B', ' ')},  /* Tibetan */
    {"bpd", HB_TAG ('B', 'A', 'D', '0')}, /* Banda-Banda -> Banda */
    {"bpl",
     HB_TAG (
	 'C', 'P', 'P', ' ')}, /* Broome Pearling Lugger Pidgin -> Creoles */
    {"bpq", HB_TAG ('C', 'P', 'P', ' ')},   /* Banda Malay -> Creoles */
    /*{"bpy",	HB_TAG('B','P','Y',' ')},*/ /* Bishnupriya -> Bishnupriya
					       Manipuri */
    ...
    {"bzc",
     HB_TAG (
	 'M', 'L', 'G', ' ')}, /* Southern Betsimisaraka Malagasy -> Malagasy */
    {"bzj", HB_TAG ('C', 'P', 'P', ' ')}, /* Belize Kriol English -> Creoles */
    {"bzk",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Nicaragua Creole English -> Creoles */
    ...
    {"cco",
     HB_TAG ('C', 'C', 'H', 'N')}, /* Comaltepec Chinantec -> Chinantec */
    {"ccq",
     HB_TAG ('A', 'R', 'K', ' ')}, /* Chaungtha (retired code) -> Rakhine */
    {"cdo",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Min Dong Chinese -> Chinese, Simplified */
    ...
    {"cjy",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Jinyu Chinese -> Chinese, Simplified */
    {"cka",
     HB_TAG ('Q', 'I', 'N', ' ')}, /* Khumi Awa Chin (retired code) -> Chin */
    ...
    {"ckz",
     HB_TAG (
	 'M', 'Y', 'N', ' ')}, /* Cakchiquel-Quiché Mixed Language -> Mayan */
    ...
    {"cmn",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Mandarin Chinese -> Chinese, Simplified */
    ...
    {"cnp", HB_TAG ('Z',
		    'H',
		    'S',
		    ' ')}, /* Northern Ping Chinese -> Chinese, Simplified */
    {"cnr", HB_TAG ('S', 'R', 'B', ' ')}, /* Montenegrin -> Serbian */
    {"cnt",
     HB_TAG ('C', 'C', 'H', 'N')}, /* Tepetotutla Chinantec -> Chinantec */
    ...
    {"cpe", HB_TAG ('C', 'P', 'P', ' ')}, /* English-based creoles and pidgins
					     [family] -> Creoles */
    {"cpf", HB_TAG ('C', 'P', 'P', ' ')}, /* French-based creoles and pidgins
					     [family] -> Creoles */
    {"cpi",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Chinese Pidgin English -> Creoles */
    /*{"cpp",	HB_TAG('C','P','P',' ')},*/ /* Portuguese-based creoles and
					       pidgins [family] -> Creoles */
    {"cpx",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Pu-Xian Chinese -> Chinese, Simplified */
    {"cqd",
     HB_TAG ('H', 'M', 'N', ' ')}, /* Chuanqiandian Cluster Miao -> Hmong */
    {"cqu", HB_TAG ('Q', 'U', 'H', ' ')}, /* Chilean Quechua (retired code) ->
					     Quechua (Bolivia) */
    {"cqu",
     HB_TAG (
	 'Q', 'U', 'Z', ' ')}, /* Chilean Quechua (retired code) -> Quechua */
    ...
    {"crp",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Creoles and pidgins [family] -> Creoles */
    ...
    {"csp", HB_TAG ('Z',
		    'H',
		    'S',
		    ' ')}, /* Southern Ping Chinese -> Chinese, Simplified */
    ...
    {"ctl",
     HB_TAG ('C', 'C', 'H', 'N')}, /* Tlacoatzintepec Chinantec -> Chinantec */
    {"cts",
     HB_TAG ('B', 'I', 'K', ' ')}, /* Northern Catanduanes Bikol -> Bikol */
    ...
    {"cvn",
     HB_TAG ('C', 'C', 'H', 'N')}, /* Valle Nacional Chinantec -> Chinantec */
    {"cwd", HB_TAG ('D', 'C', 'R', ' ')}, /* Woods Cree */
    {"cwd", HB_TAG ('T', 'C', 'R', ' ')}, /* Woods Cree -> TH-Cree */
    {"cwd", HB_TAG ('C', 'R', 'E', ' ')}, /* Woods Cree -> Cree */
    {"cy", HB_TAG ('W', 'E', 'L', ' ')},  /* Welsh */
    {"czh",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Huizhou Chinese -> Chinese, Simplified */
    {"czo",
     HB_TAG (
	 'Z', 'H', 'S', ' ')}, /* Min Zhong Chinese -> Chinese, Simplified */
    ...
    {"den", HB_TAG ('A', 'T', 'H', ' ')}, /* Slave (Athapascan) [macrolanguage]
					     -> Athapaskan */
    ...
    {"doi",
     HB_TAG ('D', 'G', 'R', ' ')}, /* Dogri (macrolanguage) [macrolanguage] */
    {"drh",
     HB_TAG ('M', 'N', 'G', ' ')}, /* Darkhat (retired code) -> Mongolian */
    ...
    {"esi",
     HB_TAG ('I', 'P', 'K', ' ')}, /* North Alaskan Inupiatun -> Inupiat */
    {"esk",
     HB_TAG ('I', 'P', 'K', ' ')}, /* Northwest Alaska Inupiatun -> Inupiat */
    ...
    {"fpe",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Fernando Po Creole English -> Creoles */
    ...
    {"fuq",
     HB_TAG ('F', 'U', 'L', ' ')}, /* Central-Eastern Niger Fulfulde -> Fulah */
    ...
    {"gcf",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Guadeloupean Creole French -> Creoles */
    {"gcl",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Grenadian Creole English -> Creoles */
    {"gcr",
     HB_TAG ('C', 'P', 'P', ' ')},	 /* Guianese Creole French -> Creoles */
    {"gd", HB_TAG ('G', 'A', 'E', ' ')}, /* Scottish Gaelic (Gaelic) */
    {"gda", HB_TAG ('R', 'A', 'J', ' ')},   /* Gade Lohar -> Rajasthani */
    /*{"gez",	HB_TAG('G','E','Z',' ')},*/ /* Geez */
    {"ggo",
     HB_TAG ('G', 'O', 'N', ' ')}, /* Southern Gondi (retired code) -> Gondi */
    ...
    {"gnw",
     HB_TAG ('G', 'U', 'A', ' ')}, /* Western Bolivian Guaraní -> Guarani */
    ...
    {"gpe",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Ghanaian Pidgin English -> Creoles */
    ...
    {"hmg",
     HB_TAG ('H', 'M', 'N', ' ')}, /* Southwestern Guiyang Hmong -> Hmong */
    {"hmh",
     HB_TAG ('H', 'M', 'N', ' ')}, /* Southwestern Huishui Hmong -> Hmong */
    ...
    {"hsn",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Xiang Chinese -> Chinese, Simplified */
    ...
    {"ik",
     HB_TAG ('I', 'P', 'K', ' ')}, /* Inupiaq [macrolanguage] -> Inupiat */
    {"ike",
    ...
    {"in",
     HB_TAG ('M', 'L', 'Y', ' ')}, /* Indonesian (retired code) -> Malay */
    ...
    {"jam",
     HB_TAG (
	 'J', 'A', 'M', ' ')}, /* Jamaican Creole English -> Jamaican Creole */
    {"jam",
    ...
    {"kmv",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Karipúna Creole French -> Creoles */
    {"kmw",
     HB_TAG ('K', 'M', 'O', ' ')}, /* Komo (Democratic Republic of Congo) */
    /*{"kmz",	HB_TAG('K','M','Z',' ')},*/ /* Khorasani Turkish -> Khorasani
					       Turkic */
    ...
    {"kpp",
     HB_TAG ('K', 'R', 'N', ' ')}, /* Paku Karen (retired code) -> Karen */
    ...
    {"ktu", HB_TAG ('K', 'O', 'N', ' ')},   /* Kituba (Democratic Republic of
					       Congo) -> Kikongo */
    ...
    {"kxl",
     HB_TAG ('K', 'U', 'U', ' ')}, /* Nepali Kurux (retired code) -> Kurukh */
    ...
    {"lzh",
     HB_TAG (
	 'Z', 'H', 'T', ' ')}, /* Literary Chinese -> Chinese, Traditional */
    ...
    {"man",
     HB_TAG ('M', 'N', 'K', ' ')}, /* Mandingo [macrolanguage] -> Maninka */
    ...
    {"mcm",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Malaccan Creole Portuguese -> Creoles */
    ...
    {"mhv",
     HB_TAG ('A', 'R', 'K', ' ')}, /* Arakanese (retired code) -> Rakhine */
    ...
    {"ml",
     HB_TAG ('M', 'A', 'L', ' ')}, /* Malayalam -> Malayalam Traditional */
    ...
    {"mnh", HB_TAG ('B',
		    'A',
		    'D',
		    '0')}, /* Mono (Democratic Republic of Congo) -> Banda */
    /*{"mni",	HB_TAG('M','N','I',' ')},*/ /* Manipuri */
    {"mnk", HB_TAG ('M', 'N', 'D', ' ')},   /* Mandinka */
    {"mnk", HB_TAG ('M', 'N', 'K', ' ')},   /* Mandinka -> Maninka */
    {"mnp",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Min Bei Chinese -> Chinese, Simplified */
    ...
    {"mvf",
     HB_TAG ('M', 'N', 'G', ' ')}, /* Peripheral Mongolian -> Mongolian */
    ...
    {"myq",
     HB_TAG (
	 'M', 'N', 'K', ' ')}, /* Forest Maninka (retired code) -> Maninka */
    ...
    {"nhe",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Eastern Huasteca Nahuatl -> Nahuatl */
    {"nhg", HB_TAG ('N', 'A', 'H', ' ')}, /* Tetelcingo Nahuatl -> Nahuatl */
    {"nhi", HB_TAG ('N', 'A', 'H', ' ')}, /* Zacatlán-Ahuacatlán-Tepetzintla
					     Nahuatl -> Nahuatl */
    {"nhk",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Isthmus-Cosoleacaque Nahuatl -> Nahuatl */
    {"nhm", HB_TAG ('N', 'A', 'H', ' ')}, /* Morelos Nahuatl -> Nahuatl */
    {"nhn", HB_TAG ('N', 'A', 'H', ' ')}, /* Central Nahuatl -> Nahuatl */
    {"nhp",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Isthmus-Pajapan Nahuatl -> Nahuatl */
    ...
    {"nhw",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Western Huasteca Nahuatl -> Nahuatl */
    {"nhx",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Isthmus-Mecayapan Nahuatl -> Nahuatl */
    {"nhy",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Northern Oaxaca Nahuatl -> Nahuatl */
    {"nhz",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Santa María La Alta Nahuatl -> Nahuatl */
    ...
    {"nln",
     HB_TAG (
	 'N', 'A', 'H', ' ')}, /* Durango Nahuatl (retired code) -> Nahuatl */
    ...
    {"npl",
     HB_TAG ('N', 'A', 'H', ' ')}, /* Southeastern Puebla Nahuatl -> Nahuatl */
    ...
    {"okm", HB_TAG ('K', 'O', 'H', ' ')}, /* Middle Korean (10th-16th cent.) ->
					     Korean Old Hangul */
    ...
    {"or",
     HB_TAG ('O', 'R', 'I', ' ')}, /* Odia (formerly Oriya) [macrolanguage] */
    ...
    {"ppa",
     HB_TAG ('B', 'A', 'G', ' ')}, /* Pao (retired code) -> Baghelkhandi */
    {"pre", HB_TAG ('C', 'P', 'P', ' ')},   /* Principense -> Creoles */
    /*{"pro",	HB_TAG('P','R','O',' ')},*/ /* Old Provençal (to 1500) ->
    ...
    {"puz",
     HB_TAG ('Q', 'I', 'N', ' ')}, /* Purum Naga (retired code) -> Chin */
    {"pwo",
    ...
    {"qub",
     HB_TAG (
	 'Q', 'W', 'H', ' ')}, /* Huallaga Huánuco Quechua -> Quechua (Peru) */
    {"qub",
    ...
    {"qur",
     HB_TAG (
	 'Q', 'W', 'H', ' ')}, /* Yanahuanca Pasco Quechua -> Quechua (Peru) */
    {"qur",
     HB_TAG ('Q', 'U', 'Z', ' ')}, /* Yanahuanca Pasco Quechua -> Quechua */
    {"qus", HB_TAG ('Q', 'U', 'H', ' ')}, /* Santiago del Estero Quichua ->
					     Quechua (Bolivia) */
    {"qus",
    ...
    {"quw",
     HB_TAG (
	 'Q', 'V', 'I', ' ')}, /* Tena Lowland Quichua -> Quechua (Ecuador) */
    ...
    {"qve",
     HB_TAG ('Q', 'U', 'Z', ' ')}, /* Eastern Apurímac Quechua -> Quechua */
    {"qvh", HB_TAG ('Q', 'W', 'H', ' ')}, /* Huamalíes-Dos de Mayo Huánuco
					     Quechua -> Quechua (Peru) */
    {"qvh", HB_TAG ('Q', 'U', 'Z', ' ')}, /* Huamalíes-Dos de Mayo Huánuco
					     Quechua -> Quechua */
    {"qvi", HB_TAG ('Q',
		    'V',
		    'I',
		    ' ')}, /* Imbabura Highland Quichua -> Quechua (Ecuador) */
    {"qvi",
     HB_TAG ('Q', 'U', 'Z', ' ')}, /* Imbabura Highland Quichua -> Quechua */
    {"qvj",
     HB_TAG (
	 'Q', 'V', 'I', ' ')}, /* Loja Highland Quichua -> Quechua (Ecuador) */
    ...
    {"qvm", HB_TAG ('Q', 'W', 'H', ' ')}, /* Margos-Yarowilca-Lauricocha Quechua
					     -> Quechua (Peru) */
    {"qvm", HB_TAG ('Q',
		    'U',
		    'Z',
		    ' ')}, /* Margos-Yarowilca-Lauricocha Quechua -> Quechua */
    {"qvn",
     HB_TAG ('Q', 'W', 'H', ' ')}, /* North Junín Quechua -> Quechua (Peru) */
    {"qvn", HB_TAG ('Q', 'U', 'Z', ' ')}, /* North Junín Quechua -> Quechua */
    {"qvo",
     HB_TAG (
	 'Q', 'V', 'I', ' ')}, /* Napo Lowland Quechua -> Quechua (Ecuador) */
    ...
    {"qwt",
     HB_TAG ('A', 'T', 'H', ' ')}, /* Kwalhioqua-Tlatskanai -> Athapaskan */
    {"qxa",
     HB_TAG (
	 'Q', 'W', 'H', ' ')}, /* Chiquián Ancash Quechua -> Quechua (Peru) */
    {"qxa",
    ...
    {"qxn", HB_TAG ('Q', 'W', 'H', ' ')}, /* Northern Conchucos Ancash Quechua
					     -> Quechua (Peru) */
    {"qxn", HB_TAG ('Q',
		    'U',
		    'Z',
		    ' ')}, /* Northern Conchucos Ancash Quechua -> Quechua */
    {"qxo", HB_TAG ('Q', 'W', 'H', ' ')}, /* Southern Conchucos Ancash Quechua
					     -> Quechua (Peru) */
    {"qxo", HB_TAG ('Q',
		    'U',
		    'Z',
		    ' ')}, /* Southern Conchucos Ancash Quechua -> Quechua */
    {"qxp", HB_TAG ('Q', 'U', 'Z', ' ')}, /* Puno Quechua -> Quechua */
    {"qxr",
     HB_TAG (
	 'Q', 'V', 'I', ' ')}, /* Cañar Highland Quichua -> Quechua (Ecuador) */
    {"qxr",
     HB_TAG ('Q', 'U', 'Z', ' ')}, /* Cañar Highland Quichua -> Quechua */
    {"qxt", HB_TAG ('Q', 'W', 'H', ' ')}, /* Santa Ana de Tusi Pasco Quechua ->
					     Quechua (Peru) */
    {"qxt",
     HB_TAG (
	 'Q', 'U', 'Z', ' ')}, /* Santa Ana de Tusi Pasco Quechua -> Quechua */
    {"qxu",
     HB_TAG ('Q', 'U', 'Z', ' ')}, /* Arequipa-La Unión Quechua -> Quechua */
    {"qxw",
    ...
    {"sam",
     HB_TAG (
	 'P', 'A', 'A', ' ')}, /* Samaritan Aramaic -> Palestinian Aramaic */
    /*{"sas",	HB_TAG('S','A','S',' ')},*/ /* Sasak */
    /*{"sat",	HB_TAG('S','A','T',' ')},*/ /* Santali */
    {"say", HB_TAG_NONE},		    /* Saya != Sayisi */
    {"sc", HB_TAG ('S', 'R', 'D', ' ')},    /* Sardinian [macrolanguage] */
    {"scf",
     HB_TAG ('C', 'P', 'P', ' ')}, /* San Miguel Creole French -> Creoles */
    {"sch", HB_TAG ('Q', 'I', 'N', ' ')}, /* Sakachep -> Chin */
    {"sci",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Sri Lankan Creole Malay -> Creoles */
    ...
    /*{"stq",	HB_TAG('S','T','Q',' ')},*/ /* Saterfriesisch -> Saterland
					       Frisian */
    ...
    {"svc",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Vincentian Creole English -> Creoles */
    ...
    {"tch",
     HB_TAG (
	 'C', 'P', 'P', ' ')}, /* Turks And Caicos Creole English -> Creoles */
    ...
    {"tdx",
     HB_TAG ('M', 'L', 'G', ' ')}, /* Tandroy-Mahafaly Malagasy -> Malagasy */
    ...
    {"tgh",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Tobagonian Creole English -> Creoles */
    ...
    {"trf",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Trinidadian Creole English -> Creoles */
    ...
    {"vic",
     HB_TAG (
	 'C', 'P', 'P', ' ')}, /* Virgin Islands Creole English -> Creoles */
    {"vit", HB_TAG_NONE},      /* Viti != Vietnamese */
    {"vkk", HB_TAG ('M', 'L', 'Y', ' ')}, /* Kaur -> Malay */
    {"vkp",
     HB_TAG ('C', 'P', 'P', ' ')}, /* Korlai Creole Portuguese -> Creoles */
    ...
    {"wuu",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Wu Chinese -> Chinese, Simplified */
    ...
    {"xst",
     HB_TAG ('S', 'I', 'G', ' ')}, /* Silt'e (retired code) -> Silte Gurage */
    ...
    {"ybd",
     HB_TAG ('A', 'R', 'K', ' ')}, /* Yangbye (retired code) -> Rakhine */
    ...
    {"zh",
     HB_TAG ('Z', 'H', 'S', ' ')}, /* Chinese, Simplified [macrolanguage] */
				  ...
				  hb_tag_t *tags /* OUT */)
{
  if (subtag_matches (lang_str, limit, "-fonnapa"))
  {
    ...
    tags[0] = HB_TAG ('A', 'P', 'P',
		      'H'); /* Phonetic transcription—Americanist conventions */
    *count = 1;
    return true;
  }
  ...
  if (subtag_matches (lang_str, limit, "-fonipa"))
  {
    ...
    tags[0] = HB_TAG ('I', 'P', 'P',
		      'H'); /* Phonetic transcription—IPA conventions */
    *count = 1;
    return true;
  }
  ...
  if (subtag_matches (lang_str, limit, "-syre"))
  {
    ...
    tags[0] =
	HB_TAG ('S', 'Y', 'R', 'E'); /* Syriac, Estrangela script-variant
					(equivalent to ISO 15924 'Syre') */
    *count = 1;
    return true;
  }
  if (subtag_matches (lang_str, limit, "-syrj"))
  {
    ...
    tags[0] =
	HB_TAG ('S', 'Y', 'R', 'J'); /* Syriac, Western script-variant
					(equivalent to ISO 15924 'Syrj') */
    *count = 1;
    return true;
  }
  if (subtag_matches (lang_str, limit, "-syrn"))
  {
    ...
    tags[0] =
	HB_TAG ('S', 'Y', 'R', 'N'); /* Syriac, Eastern script-variant
					(equivalent to ISO 15924 'Syrn') */
    *count = 1;
    return true;
  }
  switch (lang_str[0])
  ...
  case 'c':
    ...
    if (lang_matches (&lang_str[1], "do-hant-mo"))
    {
      ...
      for (i = 0; i < 2 && i < *count; i++) tags[i] = possible_tags[i];
      *count = i;
      return true;
    }
  ...
  case 'z':
    ...
    if (0 == strcmp (&lang_str[1], "h-min-nan"))
    {
       ...
       * Southern Fukien, Ho-lo (retired code) */
      tags[0] = HB_TAG ('Z', 'H', 'S', ' '); /* Chinese, Simplified */
      *count = 1;
      return true;
    }
...
hb_ot_ambiguous_tag_to_language (hb_tag_t tag)
{
  ...
  case HB_TAG ('A', 'P', 'P',
	       'H'): /* Phonetic transcription—Americanist conventions */
    return hb_language_from_string (
	"und-fonnapa", -1); /* Undetermined; North American Phonetic Alphabet */
  ...
  case HB_TAG ('C', 'P', 'P', ' '):		/* Creoles */
    return hb_language_from_string ("crp",
				    -1); /* Creoles and pidgins [family] */
  ...
  case HB_TAG ('I', 'P', 'P', 'H'): /* Phonetic transcription—IPA conventions */
    return hb_language_from_string (
	"und-fonipa", -1); /* Undetermined; International Phonetic Alphabet */
  case HB_TAG ('I', 'R', 'T', ' '): /* Irish Traditional */
    return hb_language_from_string ("ga-Latg",
				    -1); /* Irish; Latin (Gaelic variant) */
  ...
  case HB_TAG ('K', 'G', 'E', ' '):		/* Khutsuri Georgian */
    return hb_language_from_string (
	"und-Geok", -1); /* Undetermined; Khutsuri (Asomtavruli and Nuskhuri) */
  case HB_TAG ('K', 'N', 'R', ' '):	       /* Kanuri */
    return hb_language_from_string ("kr", -1); /* Kanuri [macrolanguage] */
  case HB_TAG ('K', 'O', 'H', ' '):	       /* Korean Old Hangul */
    return hb_language_from_string ("okm",
				    -1); /* Middle Korean (10th-16th cent.) */
  ...
  case HB_TAG ('P', 'G', 'R', ' '):	       /* Polytonic Greek */
    return hb_language_from_string (
	"el-polyton", -1);	    /* Modern Greek (1453-); Polytonic Greek */
  ...
  case HB_TAG ('S', 'Y', 'R', 'E'): /* Syriac, Estrangela script-variant
				       (equivalent to ISO 15924 'Syre') */
    return hb_language_from_string (
	"und-Syre", -1); /* Undetermined; Syriac (Estrangelo variant) */
  case HB_TAG ('S', 'Y', 'R', 'J'): /* Syriac, Western script-variant
				       (equivalent to ISO 15924 'Syrj') */
    return hb_language_from_string (
	"und-Syrj", -1);	    /* Undetermined; Syriac (Western variant) */
  case HB_TAG ('S', 'Y', 'R', 'N'): /* Syriac, Eastern script-variant
				       (equivalent to ISO 15924 'Syrn') */
    return hb_language_from_string (
	"und-Syrn", -1);	    /* Undetermined; Syriac (Eastern variant) */
  ...
  case HB_TAG ('Z', 'H', 'H', ' '): /* Chinese, Traditional, Hong Kong SAR */
    return hb_language_from_string (
	"zh-HK", -1);		    /* Chinese [macrolanguage]; Hong Kong */
  case HB_TAG ('Z', 'H', 'S', ' '): /* Chinese, Simplified */
    return hb_language_from_string (
	"zh-Hans", -1); /* Chinese [macrolanguage]; Han (Simplified variant) */
  case HB_TAG ('Z', 'H', 'T', ' '): /* Chinese, Traditional */
    return hb_language_from_string (
	"zh-Hant", -1); /* Chinese [macrolanguage]; Han (Traditional variant) */
  case HB_TAG ('Z', 'H', 'T', 'M'): /* Chinese, Traditional, Macao SAR */
    return hb_language_from_string ("zh-MO",
				    -1); /* Chinese [macrolanguage]; Macao */
  case HB_TAG ('Z', 'Z', 'A', ' '):	 /* Zazaki */
    return hb_language_from_string ("zza", -1); /* Zazaki [macrolanguage] */
  default: return HB_LANGUAGE_INVALID;
  }
}
