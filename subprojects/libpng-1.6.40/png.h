...
#        define png_composite_16(composite, fg, alpha, bg)                                                                                    \
            {                                                                                                                                 \
                png_uint_32 temp =                                                                                                            \
                        (png_uint_32)((png_uint_32)(fg) * (png_uint_32)(alpha) + (png_uint_32)(bg) * (65535 - (png_uint_32)(alpha)) + 32768); \
...
#        define png_composite(composite, fg, alpha, bg)                                                 \
            (composite) =                                                                               \
                    (png_byte)(0xff & (((png_uint_16)(fg) * (png_uint_16)(alpha) + (png_uint_16)(bg) * (png_uint_16)(255 - (png_uint_16)(alpha)) + 127) / 255))

#        define png_composite_16(composite, fg, alpha, bg)                                              \
            (composite) =                                                                               \
                    (png_uint_16)(0xffff & (((png_uint_32)(fg) * (png_uint_32)(alpha) + (png_uint_32)(bg) * (png_uint_32)(65535 - (png_uint_32)(alpha)) + 32767) / 65535))
...
#            define png_image_write_get_memory_size(                                                    \
                    image,                                                                              \
                    size,                                                                               \
                    convert_to_8_bit,                                                                   \
                    buffer,                                                                             \
