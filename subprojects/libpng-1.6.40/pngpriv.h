 ...
 */
#        if defined(__SSE4_1__) || defined(__AVX__) || defined(__SSSE3__) || defined(__SSE2__)          \
                || defined(_M_X64) || defined(_M_AMD64) || (defined(_M_IX86_FP) && _M_IX86_FP >= 2)
...
#define PNG_ROWBYTES(pixel_bits, width)                                                                 \
    ((pixel_bits) >= 8 ? ((size_t)(width) * (((size_t)(pixel_bits)) >> 3))                              \
...
PNG_INTERNAL_FUNCTION(
        ...
        (png_structrp, png_row_infop, png_const_bytep, const png_bytepp, const png_bytepp),
        PNG_EMPTY);
PNG_INTERNAL_FUNCTION(
        int,
